...
//    props.insert("titleFont", "titleFont");
    ...
    // TODO: Rather than do it this way... just reimplement virtual method...
    registerChildMethod("plot");
...
PlotBase *AxisBase::plot(const QString &handle)
{
    return m_plots.value(handle, 0);
}
...
void AxisBase::registerPlot(PlotBase *plot)
{
    ...
    if (m_plots.contains(key)) {
        ...
        qWarning() << "Warning: Plot handle, " << key << ", already exists in this Axis";
